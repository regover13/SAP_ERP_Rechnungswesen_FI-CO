...
Durch eine vollständige Integration zwischen der PKR und den Logistikkomponenten des SAP-Systems können Sie Betriebs-
kosten präziser bestimmen, indem Sie die Prozesskosten anhand ope-
rativer Parameter, wie z. B. der Anzahl an Kreditorenrechnungen.
Bestellungen oder abgewickelten Kundenbesch werden, berechnen
und zuweisen. Mit derTemplateverrechnung können Sie insbesondere
komplexe und anpassbare Frameworks für die Kostenverrechnung von
Geschäfisprozessen entwickeln\footnote{Vgl. \cite{Patel2009}, S. 289}.
Durch den Einsatz der Prozesskostcnrechnung und die damit
verbundene vollständige Integration mit logistischen und ope-rativen Systemen können Sie die Istkosten für Geschäftspro-zesse, Produkte und Dienstleistungen transparent darstellen.
Insbesondere Template-Verrechnungen ermöglichen Ihnen.
komplexe Kostenverrechnungen mithilfe von Geschäftsprozes-sen einfach vorzunehmen.
> Die Prozesskostenrechnung unterstützt in hohem Maße aus-fuhrliche Kostenverrechnungen, die mit Gemeinkostenzu-schlagen nicht im notwendigen Umfang durchgeführt werden
können. So können die Kosten einzelner Abteilungen reduziert
und die gesamte Kette der Geschäftsprozesse optimien wer-
den. Darüber hinaus können Sie milhilfe der Prozesskosien-
rechnung die Produkikalkulation verbessern, indem Sie die
Kosten den Geschäftsprozessen zuordnen, für die sie ursprüng-
lich angefallen sind\footnote{Vgl. \cite{Patel2009}, S. 318 f.}.

Die vollständige und nahtlose Integration der Gemeinkostenrechnung
mit anderen SAP-Komponenten ermöglicht Ihnen die Rückverfolgung
von im Kostenmanagememt zugeordneten Kosten bis zu den ursprünglich in SAP ERP Financials vorgenommenen Buchungen\footnote{Vgl. \cite{Patel2009}, S. 289}. 

in diesem Kapitel wurde unter anderem behandelt, aufweiche Weise
Sie im SAP-System Innenaufträge für einfache interne Projekte einsetzen können. 
