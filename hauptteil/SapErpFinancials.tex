...
\subsubsection{General Ledger} %Hauptbuch

\subsubsection{accounts receivable} %Debitoren
\subsubsection{accounts payable}%Kreditoren
\subsubsection{Bank Accounting}
\subsubsection{Fixed Assets Accounting}
\subsubsection{Contract Accounting}
\subsubsection{Cash Journal Accounting}
\subsubsection{Inventory Accounting}
\subsubsection{Tax Accounting}
\subsubsection{Accrual Accounting}
\subsubsection{Local Close}
\subsubsection{Financial Statemens}


\subsection{Management Accounting} %co
\subsubsection{Investment Management}
\subsubsection{Cost Center and Internal Order Accounting}
\abk{Cost Center Accounting}{dt. Kostenstellenrechnung (SAP CO-OM-CCA)}
\abk{Internal Order Accounting}{dt. Kostenstellenrechnung (SAP CO-OM-OPA)}


\subsubsection{Project Accounting}
\subsubsection{Product Cost Accounting}
\abk{Product Cost Controlling}{dt. Produktkosten-Controlling (CO-PC}
\subsubsection{Profit Center Accounting}
\subsubsection{Profitability Accounting}
\abk{Profitability Accounting}{dt. Ergebnis- und Marktsegmentrechnung (SAP CO-CA}
\subsubsection{Transfer Pricing}
%\label{sec:spc}
