...
\abk{IFRS}{International Financial Reporting Standards, dt. international anerkannte Rechnungslegungsstandards}
...
\end{compactitem}
\subsubsection*{Materieller Grundsatz: Vollständigkeit und Richtigkeit}
\begin{compactitem}
